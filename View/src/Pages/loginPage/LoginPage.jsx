...
function LoginPage() {
  ...
  async function verificarPermiso() {
    ...
    console.log("Respuesta de petición de validación", response)
    if (response.data == 1 ) {
      let refresh = localStorage.getItem("refresh")
      response = await auth.updateToken(access,refresh)
      console.log("Respuesta de petición de refresh", response)
      if(response == 200){
